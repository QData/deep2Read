...
| -----: | ----------: | :----- | :----- |
| Beilun | Generalization and Equilibrium in Generative Adversarial Nets (ICML17) + Mode Regularized Generative Adversarial Networks (ICLR17) |  | 
| [PDF](http://proceedings.mlr.press/v70/arora17a.html) + [video](https://www.youtube.com/watch?v=V7TliSCqOwI) |
