...
| -----: | ---------------------------: | :----- | :----- |
| Tianlu | Robustness of classifiers: from adversarial to random noise, NIPS16 | [PDF](https://arxiv.org/abs/1608.08967) [^1] | [PDF]({{site.baseurl}}/talks2017/20171026-Tianlu.pdf) |
| Anant |  Blind Attacks on Machine Learners, [^2] NIPS16 | [PDF](https://papers.nips.cc/paper/6482-blind-attacks-on-machine-learners) | [PDF]({{site.baseurl}}/talks2017/20171026-Anant.pdf) |
