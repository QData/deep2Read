...
| -----: | ---------------------------: | :----- | :----- |
| Jack | Learning to Query, Reason, and Answer Questions On Ambiguous Texts, ICLR17 [^1]| [PDF](https://web.eecs.umich.edu/~baveja/Papers/GuoICLR2017.pdf) | [PDF]({{site.baseurl}}/talks2017/20171017-Jack.pdf) |
| Arshdeep |  Making Neural Programming Architectures Generalize via Recursion, ICLR17 [^2]| [PDF](https://arxiv.org/abs/1704.06611) | [PDF]({{site.baseurl}}/talks2017/20170919-Arshdeep.pdf) |
| Xueying | Towards Deep Interpretability (MUS-ROVER II): Learning Hierarchical Representations of Tonal Music, ICLR17 [^3] | [PDF](https://openreview.net/pdf?id=ryhqQFKgl) | [PDF]({{site.baseurl}}/talks2017/20170921-Xueying.pdf) |
