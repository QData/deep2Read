...
| -----: | ---------------------------: | :----- | :----- |
| Jack | Learning End-to-End Goal-Oriented Dialog, ICLR17 [^1] | [PDF](https://arxiv.org/abs/1605.07683) | [PDF]({{site.baseurl}}/talks2017/20170919-Jack.pdf) |
| Bargav | Nonparametric Neural Networks, ICLR17 [^2]| [PDF](https://openreview.net/pdf?id=BJK3Xasel) | [PDF]({{site.baseurl}}/talks2017/20170919-Bargav.pdf) |
| Bargav | Learning Structured Sparsity in Deep Neural Networks, NIPS16 [^3]| [PDF](https://arxiv.org/abs/1608.03665) | [PDF]({{site.baseurl}}/talks2017/20170912-Bargav.pdf) |
| Arshdeep | Learning the Number of Neurons in Deep Networks, NIPS16 [^4]| [PDF](https://papers.nips.cc/paper/6372-learning-the-number-of-neurons-in-deep-networks) | [PDF]({{site.baseurl}}/talks2017/20170912-Arshdeep.pdf) |
